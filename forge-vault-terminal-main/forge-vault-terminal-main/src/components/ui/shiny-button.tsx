...
.shiny-cta {
  ...
  --shiny-cta-fg: #ffffff;
  --shiny-cta-highlight: #c81d25;
  --shiny-cta-highlight-subtle: #ff8488;
...
.shiny-cta:active:not(:disabled) { translate: 0 1px; }
.shiny-cta::before {
...
.shiny-cta:is(:hover, :focus-visible):not(:disabled)::after { animation-play-state: running; }
.shiny-cta:is(:hover, :focus-visible):not(:disabled) span::before { opacity: 1; }
